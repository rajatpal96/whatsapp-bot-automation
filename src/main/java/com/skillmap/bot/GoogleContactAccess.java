...
public class GoogleContactAccess {
...
//	This method will authenticate the user credentials passed to it and returns an instance of ContactService class.*/
	...
	public ContactsService authenticateId(String userid, String password){
		...
		try{
			contactService = new ContactsService("ContactApi");
	...
	public static void printAllContacts(ContactsService myService)
		  ...
		  for (ContactEntry entry : resultFeed.getEntries()) {
		    ...
		    for (com.google.gdata.data.extensions.Im im : entry.getImAddresses()) {
		    ...
		    com.google.gdata.data.Link photoLink = entry.getContactPhotoLink();
		...
		public static void main(String args[]) {
			try {
				...
				GoogleContactAccess googleContactsAccess = new GoogleContactAccess();

				ContactsService contactSrv = googleContactsAccess.authenticateId("rajatkokila96@gmail.com", "Skillmap_10");
